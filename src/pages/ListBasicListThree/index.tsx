...
interface ListBasicListThreeProps extends FormComponentProps {
  listBasicListThree: StateType;
  dispatch: Dispatch<any>;
  loading: boolean;
}
interface ListBasicListThreeState {
  visible: boolean;
  done: boolean;
...
class ListBasicListThree extends Component<ListBasicListThreeProps, ListBasicListThreeState> {
  state: ListBasicListThreeState = { visible: false, done: false, current: undefined };
...
export default Form.create<ListBasicListThreeProps>()(ListBasicListThree);
